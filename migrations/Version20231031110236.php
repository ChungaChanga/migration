 ...
 */
final class Version20231031110236 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE customer (id INT NOT NULL, source_id INT NOT NULL, dest_id VARCHAR(255) NOT NULL, transfer_status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE "order" (id INT NOT NULL, customer_id INT DEFAULT NULL, source_id INT NOT NULL, dest_id VARCHAR(255) NOT NULL, transfer_status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE product (id INT NOT NULL, source_id INT NOT NULL, dest_id VARCHAR(255) NOT NULL, transfer_status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
